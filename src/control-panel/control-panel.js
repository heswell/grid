...
export default function ControlPanel({ height, messageRef, onAction, onChange, state: stateProp }) {
  ...
  const availableLocations = config[stateProp.dataGrid].dataSources[stateProp.dataSource];
  const actions = dataSources[stateProp.dataSource].actions;
  ...
  return (
    <div className={classes.root} style={{ height }}>
      ...
      <div className={classes.body}>
        ...
        <div className={classes.tabPanel} hidden={selectedTab !== 4}>
          <p ref={messageRef}></p>
        </div>
