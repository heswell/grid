...
export type incrementDepth = (depth: number) => number;
export declare const incrementDepth: incrementDepth; 

export type decrementDepth = (depth: number) => number;
export declare const decrementDepth: decrementDepth; 
